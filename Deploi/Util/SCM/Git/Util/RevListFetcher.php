<?php
	...
	use Deploi\Util\SCM\Git\Object\Commit;

	class RevListFetcher extends Command
	{
		/**
		 ...
		 *
		 * @return RevListFetcher The "$this" object
		 */
		 ...
		 * Fetch the commits
		 *
		 * @return array An array of instances of Commit
		 */
		public function fetch()
		{
			...
			while(count($lines))
			{
				...
				$commits[] = Commit::createInstanceByArray($this->git, array(
																			'commit'    => $commit,
																			'tree'      => $tree,
																			'parents'   => $parents,
																			'author'    => $author,
